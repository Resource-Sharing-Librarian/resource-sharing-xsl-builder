          ...
          <div class="rsSlip rsSlipInner">
            ...
            <div class="messageArea">
              <div class="messageBody">
                ...
                <table role="presentation" border="0" cellspacing="0" cellpadding="0" style="width:350px; max-width:350px; border-collapse:collapse; table-layout:fixed;">
                  <tr>
...
@@HEADER_ADJACENT_LABEL_CELL@@
                ...
                <table role="presentation" cellspacing="0" cellpadding="2" border="0" style="width:350px; max-width:350px; table-layout:fixed;">
                  ...
                  <xsl:if test="notification_data/incoming_request/format = 'PHYSICAL'">
                    ...
                    <!-- BEGIN METADATA: shelving-location-for-item -->
                    ...
                    <!-- END METADATA: shelving-location-for-item -->
